...
- **必ず全てのレシピの国を統一してください。**
- **可能であれば、同じ国の中の同じ地域のレシピで構成してください（例: イタリア・トスカーナ地方の料理で統一）。**
- **食材の扱い**:
  - 【使いたい食材】は、コース内の**少なくとも1つのレシピ**に含まれていれば問題ありません（全てのレシピに含める必要はなく、料理ごとに分けて使用しても構いません）。
  - 【除外したい食材】は、コース内の**全てのレシピにおいて絶対に使用しないでください**。
- **コースの最適化**: コース全体のバランス、味の構成（塩味、酸味、甘味等の流れ）、および彩りを考慮して、最適なメニューを提案してください。
