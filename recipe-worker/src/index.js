...
- **味の重複禁止（重要）**: 梅酢などの特徴的な調味料や味付けを複数の料理で繰り返さないでください。前菜からデザートまで、味の抑揚とバリエーションを重視してください。
- **食材の扱い**:
  - 【使いたい食材】は、コース全体の**どこか1つのレシピ**に含まれていれば問題ありません。全てのレシピに含める必要はなく、特定の1品に集中させても、ちりばめても構いません。
