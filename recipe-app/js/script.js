...
async function handleCopyPrompt() {
    ...
    const promptCuisineInstruction = data.time === "コース"
        ? `【コース提案】その国の料理でフルコースを提案してください。国を統一し、可能であれば同じ地域のレシピで構成してください。梅酢などの特定の味や調味料を複数の料理で繰り返さないでください（味の重複禁止）。【使いたい食材】はコース全体のどこか1品に含まれていればよく、無理に全ての料理に含めないでください。食前酒・食後の飲み物は対象外です。`
        : "";
