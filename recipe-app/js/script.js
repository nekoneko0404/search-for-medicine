...
// Symptoms List
const SYMPTOMS = [
    { label: '塩分・カリウム', value: '塩分控えめ・カリウム' },
    { label: '糖質・食物繊維', value: '低糖質・食物繊維' },
    { label: 'タンパク質・塩分', value: 'タンパク質調整・減塩' },
    { label: '栄養バランス', value: '栄養バランス・ビタミン' },
    { label: 'カロリー・脂質', value: '低カロリー・低脂質' },
    { label: 'プリン体', value: 'プリン体控えめ' },
    { label: 'カルシウム', value: 'カルシウム・ビタミンD' },
    { label: 'タンパク質強化', value: '高タンパク' },
    { label: 'DHA・EPA', value: '脳の健康（DHA・EPA）' },
    { label: '脂質バランス', value: '良質な脂質（DHA・EPA）' },
    { label: '食物繊維・大豆', value: 'コレステロール対策（食物繊維・大豆）' },
    { label: 'ビタミンC・亜鉛', value: '免疫ケア（ビタミンC・亜鉛）' },
    { label: 'ビタミンB1・E', value: '血行・筋肉ケア（ビタミンB1・E）' },
    { label: '鉄分・ビタミンE', value: '身体を温める（鉄分・ビタミンE）' },
    { label: 'ビタミンB群', value: '疲労回復（ビタミンB群）' },
    { label: '食物繊維・発酵食', value: '腸内環境（食物繊維・乳酸菌）' },
    { label: '鉄分・葉酸', value: '鉄分補給' },
    { label: 'ビタミンC・B群', value: '肌の健康（ビタミンC・B）' },
];
