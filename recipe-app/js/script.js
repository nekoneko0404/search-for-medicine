...
// Symptoms List
const SYMPTOMS = [
    { label: '塩分が気になる', value: '塩分控えめ・カリウム' },
    { label: '糖質が気になる', value: '低糖質・食物繊維' },
    { label: '塩分・タンパクを控えたい', value: 'タンパク質調整・減塩' },
    { label: '飲み過ぎ・食べ過ぎ', value: '消化の良い食事・肝臓ケア' },
    { label: 'カロリーが気になる', value: '低カロリー・低脂質' },
    ...
    { label: '脂質の摂りすぎ', value: '良質な脂質・低脂質' },
    { label: '食生活を見直したい', value: '食物繊維・バランス' },
    { label: '季節の変わり目', value: '免疫ケア（ビタミンC・亜鉛）' },
    { label: 'デスクワーク疲れ', value: '血行促進（ビタミンE）' },
    { label: '手足の冷え', value: '身体を温める（生姜・鉄分）' },
    { label: 'スタミナ不足', value: '疲労回復（ビタミンB群）' },
    { label: 'お腹の調子', value: '腸内環境（食物繊維・乳酸菌）' },
    { label: '鉄分不足', value: '鉄分補給' },
    { label: '美容・肌ケア', value: '肌の健康（ビタミンC・B）' },
];
